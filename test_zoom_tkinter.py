...
class MainWindow(Frame):
    ...
    def __init__(self, mainframe, path):
        ...
        Frame1 = Frame(self.master, bg="gray")
        Frame1.grid(row=0, column=0, rowspan=7, sticky=W+E+N+S)

        Frame3 = Frame(self.master, bg="gray10")
        Frame3.grid(row=7, column=0, rowspan=9, sticky=W+E+N+S)
        
        Frame1.rowconfigure(0, weight=1)  # make the CanvasImage widget expandable
        Frame1.columnconfigure(0, weight=1)

        canvas = CanvasImage(Frame1, path)  # create widget
